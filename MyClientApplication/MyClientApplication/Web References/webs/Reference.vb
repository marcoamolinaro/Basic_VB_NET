...
Namespace webs
    ...
    Partial Public Class MyWebService
        ...
        Private AddUpOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.MyClientApplication.My.MySettings.Default.MyClientApplication_webs_MyWebService
        ...
        '''<remarks/>
        Public Event AddUpCompleted As AddUpCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/AddUp", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function AddUp(ByVal a As Integer, ByVal b As Integer) As Integer
            Dim results() As Object = Me.Invoke("AddUp", New Object() {a, b})
            Return CType(results(0),Integer)
        End Function
        
        '''<remarks/>
        Public Overloads Sub AddUpAsync(ByVal a As Integer, ByVal b As Integer)
            Me.AddUpAsync(a, b, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub AddUpAsync(ByVal a As Integer, ByVal b As Integer, ByVal userState As Object)
            If (Me.AddUpOperationCompleted Is Nothing) Then
                Me.AddUpOperationCompleted = AddressOf Me.OnAddUpOperationCompleted
            End If
            Me.InvokeAsync("AddUp", New Object() {a, b}, Me.AddUpOperationCompleted, userState)
        End Sub
        
        Private Sub OnAddUpOperationCompleted(ByVal arg As Object)
            If (Not (Me.AddUpCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent AddUpCompleted(Me, New AddUpCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9037.0")>  _
    Public Delegate Sub AddUpCompletedEventHandler(ByVal sender As Object, ByVal e As AddUpCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9037.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class AddUpCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
